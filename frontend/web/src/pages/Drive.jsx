...
const SCENARIOS = [
  ...
  { key: 'accounting', title: 'Accounting item', icon: 'cards', tone: 'warn', cta: 'Drive',
    desc: 'R-2031 blocked on Motif MB014 with account 410000 / JE-8801 / 12,450,000 fee income. Then Adjust from the instance, owner sign-off, GLA countersign.',
    run: () => runScenario('accounting') },
