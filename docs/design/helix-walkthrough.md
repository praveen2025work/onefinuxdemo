...
Play this first: [`helix-walkthrough.mp4`](helix-walkthrough.mp4) (~3 minutes, spoken stereo audio). Voice-only: [`helix-walkthrough.mp3`](helix-walkthrough.mp3). Script: [`helix-narration.txt`](helix-narration.txt). Long silent cut of every control: [`helix-silent-walkthrough.mp4`](helix-silent-walkthrough.mp4).
