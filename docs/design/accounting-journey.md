...
3. Open the row: account `410000`, journal `JE-8801`, amount, FS line. The Helix embed is the primary iframe. Lineage grids (investigation, close) sit on the same page. Click a feed for history.
