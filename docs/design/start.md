...
Motif, SAP, Helix and Axiom stay as they are. They publish facts. One Finance UX **stitches** those facts into Ready / Blocked / Delayed and acts when ready. Kafka and Airflow stay in the mix as bus and batch; they do not replace this layer — [`build-vs-buy.md`](build-vs-buy.md).
