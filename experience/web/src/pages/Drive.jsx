...
const SCENARIOS = [
  ...
  { key: 'fobo', title: 'FOBO stitch', icon: 'board', tone: 'ok', cta: 'Drive',
    desc: 'The stitch example — R-1042 folds to READY, R-2031 is BLOCKED on a failed key.',
    run: () => runScenario('fobo') },
  { key: 'helix', title: 'FOBO / Helix', icon: 'share', tone: 'ok', cta: 'Drive',
    desc: '300 Motif master books fold to ready, then the hub commands Helix to run the rec.',
