...
def render() -> str:
    ...
    a("### 1.2 Status")
    a("")
    a("This specification describes the as-built phase-1 product: `onefinux-hub` on port 7070, `source-simulator` on port 7081, and `frontend/web` on port 5173. Later bus mix, live CEES, live Helix, and Wijmo are listed under Out of scope.")
    a("")
    ...
    a("| `frontend/web` | 5173 | Entitled console |")
    a("")
    a("### 9.2 Event path")
    a("")
    ...
    a("")
    a("Start hub and simulator with `./scripts/run.sh`. Start `frontend/web` on 5173. Execute CONSOLE, REPORTS, GOVERN, and OPERATE AC-IDs in the browser. Record the AC-ID in the pull request.")
    a("")
